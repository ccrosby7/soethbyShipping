...
import com.crosby.soethbyshipping.domain.JobHistory;
import com.crosby.soethbyshipping.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.crosby.soethbyshipping.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "soethbyShippingJobHistory";
