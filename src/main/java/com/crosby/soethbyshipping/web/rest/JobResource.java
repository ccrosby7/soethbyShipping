...
import com.crosby.soethbyshipping.domain.Job;
import com.crosby.soethbyshipping.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.crosby.soethbyshipping.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "soethbyShippingJob";
